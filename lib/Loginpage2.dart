...
import 'package:project/otppage.dart';
  ...
  class _Loginpage2State extends State<Loginpage2> {
    ...
    Future<void> _sendOtp() async {
      FocusScope.of(context).unfocus(); if (!_formKey.currentState!.validate()) return;
      ...
      try {
        ...
        final DataSnapshot rtdbSnapshot = await FirebaseDatabase.instance
            ...
            .equalTo(phone)
            .get();
        final bool userExists = firestoreResult.docs.isNotEmpty || rtdbSnapshot.exists;
        ...
        await FirebaseAuth.instance.verifyPhoneNumber(
          ...
          verificationFailed: (FirebaseAuthException e) {
            ...
            if (e.code == 'app-not-authorized') msg = "App Not Authorized (Check SHA-1 Key)";
            if (e.code == 'too-many-requests') msg = "Too many attempts. Try again later.";
            if (e.code == 'network-request-failed') msg = "Network Error. Check Internet/Permissions.";
                    ...
                    child: BackdropFilter(
                      ...
                      child: Container(
                        ...
                        padding: EdgeInsets.symmetric(
                            vertical: isSmallScreen ? 30 : 45, horizontal: 30),
                        decoration: BoxDecoration(
                              ...
                              SizedBox(
                                ...
                                child: ElevatedButton(
                                  ...
                                  style: ElevatedButton.styleFrom(
                                    ...
                                    elevation: 10,
                                    shadowColor:
                                        const Color(0xFFDA008A).withOpacity(0.4),
      ...
      return Expanded(
        child: GestureDetector(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              color:
                  isSelected ? const Color(0xFFDA008A) : Colors.transparent,
