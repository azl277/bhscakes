...
class _Profilepage2State extends State<Profilepage2> {
        ...
        child: Column(
          children: [
            ...
            const Padding(
              ...
              child: Divider(height: 30, color: Color(0xFFEEEEEE)),
            ),
            Padding(
  ...
  Future<void> _determinePosition() async {
    ...
    try {
      ...
      if (dist > 15000) {
        ...
        _showError(
          "Out of Zone",
          "We currently only deliver within 15km of our bakery.",
        );
        return;
      }
      ...
      _showError(
        "Location Error",
        "Could not fetch your location. Please ensure GPS is enabled.",
      );
    }
  }
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async {
                        if (houseCtrl.text.isEmpty || phoneCtrl.text.isEmpty)
                          return;
  ...
  Future<void> _updateUserName(String newName) async {
    ...
    try {
      ...
      _showError(
        "Update Failed",
        "Could not save your new name. Please try again.",
      );
    }
  }
